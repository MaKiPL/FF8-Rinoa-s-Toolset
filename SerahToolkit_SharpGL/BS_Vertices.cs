...
{
    internal partial class BsVertices : Form
    {
        ...
        public BsVertices(string lastPath, int offset, SharpGlForm sl)
        {
            ...
            InitializeComponent();
            _lastPath = lastPath;
            FileStream fs = new FileStream(lastPath, FileMode.Open);
        ...
        private void ParseToHex()
        {
            ...
            FileStream fs = new FileStream(_lastPath, FileMode.Open);
        ...
        private void UpdateHex(byte[] parsedbyte) => textBox4.Text = BitConverter.ToString(parsedbyte).Replace("-"," ");
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e) => CalculateXyz(_lastPath, int.Parse(listBox1.Items[listBox1.SelectedIndex].ToString()));
